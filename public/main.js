...
const drawFive = () => {
    axios.get('http://18.189.16.56/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://18.189.16.56/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://18.189.16.56/api/player')
...
const getAllBots = () => {
    axios.get('http://18.189.16.56/api/robots')
        .then(({data}) => {
